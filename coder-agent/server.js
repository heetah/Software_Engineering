...
const { errorHandlerMiddleware, requestIdMiddleware, createSuccessResponse } = require('../shared/errors');

const app = express();
app.use(requestIdMiddleware);
app.use(bodyParser.json({ limit: '10mb', type: 'application/json', verify: (req, res, buf, encoding) => {
