...
-主資料夾-
    agents/
        coder-agent/
            ...
            **coordinator.cjs**：Coder 協調器，共分三階段生成  Phase0 - 自動生成 config
                            Phase1 - 生成骨架
    ...
    generators/
        **base-generator.js**：生成器的 base 基底，提供通用方法（e.g. 確保meta標籤）
        **basic-generator.js**：基本生成器，生成基本的 HTML/CSS/JS 模板，處理TODO註釋，並確保基本結構完整性
    ...
    dev_page/
        ...
        **main-window.js**：主視窗渲染、事件監聽、IPC通訊、對話管理
        **style.css**：主視窗樣式設計
